                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__item-wrap">
                        ...
                        <ul class="footer__social-list">
                            ...
                            <li class="footer__social-list-item">
                                <a href="{{$frontendSettings->twiter}}" target="_blank" class="footer__social-list-item-lisk">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li>
                            <li class="footer__social-list-item">
                                <a href="{{$frontendSettings->instragram}}" target="_blank" class="footer__social-list-item-lisk">
